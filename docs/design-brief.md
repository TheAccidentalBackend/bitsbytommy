...
- Name: Bits by Tommy
- Tagline (English): Tech, tailored.
- Tagline (Dutch): Technologie op maat.
- Tagline (French): La technologie sur mesure.
- Service area: Gistel & omgeving
- French service area wording: Gistel et environs
- English service area wording: Gistel & surrounding areas
- Work farther away is possible when travel costs are agreed beforehand.
...
- Knowledgeable without boasting
- Patient without being patronising
- Personal without becoming informal or vague
- Honest about what customers need and do not need
- Clear, practical, and free of unnecessary jargon
...
The visual theme is quiet performance: refined technology with the restraint and precision of a premium performance car.

- Deep graphite: `#0B0D0F`
...
Use a typographic wordmark with `bits` in confident lowercase and `BY TOMMY` as a smaller monospaced label. The dot above the `i` can become a wine-red square. A minimal four-square motif with one selected wine-red bit can serve as the favicon.
